                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="0x..."
                                    className="w-full px-4 py-3 rounded-xl bg-notary-dark border border-notary-slate-dark text-gray-500 placeholder-slate-500 focus:border-notary-cyan focus:ring-1 focus:ring-notary-cyan transition-all font-mono text-sm"
                                />
                            </div>
